...
| **Public Holidays** | The model assumes warehouse operations every calendar day in June, consistent with the Jan–May 2022 historical data which shows no zero-receiving days. However, German public holidays falling in June 2022 (Whit Monday Jun 6, Corpus Christi Jun 16) are not explicitly accounted for. If the warehouse observes these holidays, actual receipts on those days would be zero or significantly reduced, with volume shifting to adjacent days. |
